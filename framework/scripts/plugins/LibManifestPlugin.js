...
const { someInIterable } = require("webpack/lib/util/IterableHelpers");
		...
		compiler.hooks.emit.tapAsync(
			...
			(compilation, callback) => {
                ...
                if (this.options.entryName) {
                  ident = this.options.entryName(ident)
                }
								...
								delete buildMeta.tsLoaderDefinitionFileVersions
								delete buildMeta.tsLoaderFileVersion
